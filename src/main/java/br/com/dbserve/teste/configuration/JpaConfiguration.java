package br.com.dbserve.teste.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.dbserve.teste.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.dbserve.teste.model" });
